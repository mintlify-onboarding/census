...
![](/images/sources/Screen%20Shot%202021-11-14%20at%204.56.39%20PM.png)

Make sure to have no spaces in the API key name

After creating the key, check which region your Rockset instance is deployed to and copy the API key.

![](/images/sources/Rockset%20Credentials.png)

Take a mental note of which region you are deployed to in Rockset
...
![](/images/sources/Census%20Rockset%20Credentials.png)
