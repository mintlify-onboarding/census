...
GRANT USAGE ON ALL FUNCTIONS IN SCHEMA ""."" TO ROLE CENSUS_ROLE;
GRANT USAGE ON FUTURE FUNCTIONS IN SCHEMA ""."" TO ROLE CENSUS_ROLE;
...
GRANT CREATE STAGE ON SCHEMA "CENSUS"."CENSUS" TO ROLE CENSUS_ROLE;</strong,>
```
