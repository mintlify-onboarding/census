...
These permissions are required for both [Basic and Advanced sync engines](/sources/overview#sync-engines). They give Census read-only access to any tables and views in any schemata that you would like Census to publish to your service destinations. 
