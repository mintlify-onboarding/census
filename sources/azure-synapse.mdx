...
GRANT SELECT, VIEW DEFINITION ON SCHEMA:: TO CENSUS;</strong,>
```
...
Census can successfully connect to Azure Synapse instances that are using advanced networking controls including region constraints, IP address allow lists, or SSH Tunneling. For more information, see our [Network Access Controls](/basics/security-and-privacy/regions-and-ip-addresses) documentation.
