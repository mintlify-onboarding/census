...
![](/images/basics/security%20logos.png)
...
![](/images/basics/Census%20Security%20Architecture%402x.png)
...
The Census user account that accesses your warehouse is not a `superuser` \- it is a least-privilege account that can only read from the schemas that you choose and can only write to the `Census` bookkeeping schema. Read more [in our data sources documentation](/sources/snowflake#required-permissions).
...
![](/images/basics/security_step_2.png)
...
We support using your own blob storage for an extra layer of security and privacy. [Read more here 👉](/basics/security-and-privacy/configuring-census-to-use-an-s3-bucket-you-control)
...
![](/images/basics/security_step_3.png)
...
![](/images/basics/security_step_4.png)
