...
* **Outreach account**: We recommend using a dedicated service account with Admin user profile privileges. (See [Required Permissions](/destinations/outreach#required-permissions).)
...
![](/images/destinations/202109_Service_Connection_Outreach.png)

Destinations page with Outreach
...
![](/images/destinations/202109_Connections_Outreach.png)

Destinations page with data warehouse and Outreach
...
3. Under **Where do you want to sync data to?**, choose Outreach as the **Connection** and an **Object** in Outreach. (See [Supported Objects](/destinations/outreach#supported-objects).)

4. Under **How should changes to the source be synced?**, choose **Update or Create**. (See [Supported Sync Behaviors](/destinations/outreach#supported-sync-behaviors).)

5. Under **How are source and destination records matched?**, select a mapping key. (See [Supported Objects](/destinations/outreach#supported-objects) for details.)
...
![](/images/destinations/202109_Sync_Details.png)

Sync setup for Outreach
...
![](/images/destinations/202110_Custom_Fields_Outreach.png)

Sync setup displays custom fields without the custom field name
