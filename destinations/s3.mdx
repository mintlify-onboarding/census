...
![](/images/destinations/Screen%20Shot%202022-04-13%20at%209.40.28%20PM.png)
...
![](/images/destinations/Screen%20Shot%202022-04-13%20at%209.41.48%20PM.png)
...
* Finish setting up your Role. Note that it should have the [required permissions](/destinations/s3#required-permissions) to access the bucket you are using as your Census destination!
...
* We support syncing files up to 100GB. Files larger than 5GB may require some additional permissions, see [🔐 Required permissions](/destinations/s3#required-permissions) below.
...
* If your configured delimiter is present in data values, Census will automatically add double quotes around the value._Example:_ _`Hello, world`_ _is written as as_ _`"Hello, world"`_ _if the chosen delimiter is a comma._
