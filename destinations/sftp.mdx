...
![](/images/destinations/Screen%20Shot%202021-10-11%20at%206.14.04%20PM.png)
...
![](/images/destinations/Screen%20Shot%202021-10-11%20at%206.11.44%20PM.png)
...
3. Under **Where do you want to sync data to?**, choose the name you assigned in Step 1 (we used **SFTP**) as the **Connection**. Enter the **File Path** for the CSV file where data will sync. The path can accept variables that will populate when the sync runs. See [File Path Variables](/destinations/sftp#file-path-variables). Confirm the file path in the **Template Preview** field.
...
![](/images/destinations/Screen%20Shot%202021-10-11%20at%206.18.52%20PM.png)
...
If everything went well, that's it! You've started syncing data from your warehouse to your SFTP server! [🥳️](https://emojikeyboard.org/copy/Partying%5FFace%5FEmoji%5F%F0%9F%A5%B3%EF%B8%8F?utm%5Fsource=extlink)
