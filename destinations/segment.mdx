...
![](/images/destinations/Screen%20Shot%202021-11-12%20at%2011.16.21%20AM.png)

* Census will convert this right here and now you're all set with the Segment Connection!

![](/images/destinations/Screen%20Shot%202021-11-12%20at%2011.16.53%20AM.png)
...
* Pick the name of Segment service from step 1 as **the Connection**, right now the object we can sync to is [limited to **User**](/destinations/segment#supported-objects)

For the " **How should changes to the source be synced?"** section‌

* **Update or Create** will be preselected as it is [supported](/destinations/segment#supported-sync-behaviors)
...
![](/images/destinations/Screen%20Shot%202021-11-12%20at%2011.37.07%20AM.png)
...
Like most [Events](/basics/data-models-and-entities/defining-source-data/events), Segment Track Events have the standard set of fields. Though the `event` type field is the only required field, you should typically set at least all the standard event fields.
...
* `properties` \- Acts as a Properties bundle. See[Using the Properties Bundle](/basics/data-models-and-entities/defining-source-data/events#using-the-properties-bundle) for more information.

* `context` and `integrations` \- Optional event context and controls. See [Arrays and Nested Objects](/basics/data-models-and-entities/defining-source-data/structured-data) for more information on how to create objects to map to these fields.
