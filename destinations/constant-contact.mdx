...
![](/images/destinations/constant-contact.png)
...
**Note**: when syncing contacts from Census, **List Ids** is a required field. This needs to be an array of strings, each of which is the ID (not name) of an _existing_ contact list in Constant Contact.
