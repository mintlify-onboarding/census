...
![](/images/destinations/screely-1645633320514.png)
...
![](/images/destinations/screely-1645633928224.png)
...
3. Under **Where do you want to sync data to?**, choose Pardot as the **Connection** and the **Prospect Object** in Pardot. (See [Supported Objects](/destinations/outreach#supported-objects).)

4. Under **How should changes to the source be synced?**, choose **Update Only**. (See [Supported Sync Behaviors](/destinations/outreach#supported-sync-behaviors).)
...
![](/images/destinations/screely-1645633654766.png)
...
![](/images/destinations/Pardot%20List%20ID.png)

Lookup by List ID

![](/images/destinations/Pardot%20List%20Name.png)
